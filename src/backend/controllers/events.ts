...
export function createEventsController(api: Api) {
  return {
    ...
    packingItems: {
      create: (id: string, body: Parameters<Api["events"]["packingItems"]["create"]>[1]) =>
    ...
    assignments: {
      create: (id: string, body: Parameters<Api["events"]["assignments"]["create"]>[1]) =>
    ...
    volunteers: {
      create: (id: string, body: Parameters<Api["events"]["volunteers"]["create"]>[1]) =>
