...
const contactCreateItem = t.Object(
  {
    ...
    ok_to_sms: t.Optional(consentStatus),
    ...
    hellenic: t.Optional(t.Boolean()),
    deceased: t.Optional(t.Boolean()),
    deceased_year: t.Optional(t.Union([t.Number(), t.Null()])),
...
export const ContactsDto = {
  ...
  listQuery: t.Object({
    ...
    hellenic: t.Optional(t.String()),
    excludeDeceased: t.Optional(t.String()),
