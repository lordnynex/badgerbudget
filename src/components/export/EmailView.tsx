...
<body style="font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5; color: #333; max-width: 700px; margin: 0 auto; padding: 24px;">
  ...
  <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
    ...
    <tr><td style="padding: 6px 0; border-bottom: 1px solid #eee;">Attendance breakdown</td><td style="padding: 6px 0; border-bottom: 1px solid #eee; text-align: right;">25%: ${summary.attendanceBreakdown[0]?.tickets ?? 0} / 50%: ${summary.attendanceBreakdown[1]?.tickets ?? 0} / 75%: ${summary.attendanceBreakdown[2]?.tickets ?? 0} / 100%: ${summary.attendanceBreakdown[3]?.tickets ?? 0} attendees</td></tr>
    <tr><td style="padding: 6px 0; border-bottom: 1px solid #eee;">Lowest ticket price (break even)</td><td style="padding: 6px 0; border-bottom: 1px solid #eee; text-align: right;">${summary.lowestBreakEven != null ? "$" + summary.lowestBreakEven : "—"}</td></tr>
    <tr><td style="padding: 6px 0; border-bottom: 1px solid #eee;">Day pass revenue</td><td style="padding: 6px 0; border-bottom: 1px solid #eee; text-align: right;">$${summary.dayPassRevenue.toLocaleString()}</td></tr>
  </table>
