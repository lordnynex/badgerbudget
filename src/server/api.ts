...
export const api = {
  ...
  seed: async () => {
    ...
    // Original early return: if user already has events and budgets, do NOT run main seed block.
    // Only add contacts if missing (for existing DBs upgrading to contacts module).
